...
public interface ConstantValue{
	...
	int[] simpleAnim = { R.anim.a1, R.anim.a2, R.anim.alpha, R.anim.alpha_rotate,
	...
	String[] simpleName = { "a1", "a2", "alpha", "alpha_rotate", "alpha_scale",
			...
			"my_animation_set", "my_own_design", "push_left_in", "push_left_out",
	...
	String[] listViewName = { "上下拉刷新的ListView", "滑动删除条目的ListView",
			...
			"翻页效果的ListView", "八种横向切换+ListView效果" };

	// ---------------------------自定义控件合集Main页面------------------------------------
	String[] customName = { "自定义FrameLayout文字飞入飞出效果", "在任意控件上增加带数字的气泡效果",
			"圆形旋转菜单(自定义Layout+ImageView)", "ListView循环更换标题效果",
			"自定义Gallery+ListView效果", "自定义LinearLayout侧边栏效果", "自定义横向ScrollView",
			"自定义ProgressBar(4种样式)", "自定义加载LoadingDialog样式", "自定义PopWindow",
