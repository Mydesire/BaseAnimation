package com.xhq.baseanimation.ui.customview.badger;
 ...
 *
 */
public class BadgerMainActivity extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_badger_main);
    	...
    	badge6.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(BadgerMainActivity.this, "clicked badge", Toast.LENGTH_SHORT).show();
			}
		});
