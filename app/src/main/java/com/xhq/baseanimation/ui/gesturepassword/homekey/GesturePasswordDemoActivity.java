package com.xhq.baseanimation.ui.gesturepassword.homekey;
...
import com.xhq.baseanimation.common.Constants;
import com.xhq.baseanimation.ui.gesturepassword.homekey.LocusPassWordView.OnCompareListener;
import com.xhq.baseanimation.ui.gesturepassword.homekey.LocusPassWordView.OnCompleteListener;
import com.xhq.baseanimation.ui.gesturepassword.homekey.LocusPassWordView.onCheckListener;
import com.xhq.baseanimation.utils.Logger;
import com.xhq.baseanimation.utils.SPUtil;
import com.xhq.baseanimation.utils.SlideToggle;
import com.xhq.baseanimation.utils.SlideToggle.OnSwitchStateListener;
...
public class GesturePasswordDemoActivity extends GestureParentActivity {
	...
	public void init() {
		...
		stateFlag = SPUtil.getBooleanValueFromSP(this,
		...
		defaultPassword = SPUtil.getStringValueFromSP(this,
                                                      Constants.GPNAMEINSHARED, "password");
		SPUtil.setBooleanDataIntoSP(this, Constants.GPNAMEINSHARED,
                                    "cleared", false);
	...
	protected void onResume() {
		super.onResume();
			cleared = SPUtil.getBooleanValueFromSP(this,
	...
	private OnSwitchStateListener onSwitchListener = new OnSwitchStateListener() {
		...
		public void onSwitch(boolean state) {
			if (state) {// 打开手势密码，更新开关状态值为true，开关改变值也为true，
				llPassword.setVisibility(View.VISIBLE);
				SPUtil.setBooleanDataIntoSP(GesturePasswordDemoActivity.this,
	...
	private OnCompleteListener lpwvOnCompleteListener = new OnCompleteListener() {
		...
		public void onComplete(String firstPassword, String secondPassword) {
			...
			if (firstPassword.equals(secondPassword)) {
				...
				SPUtil.setDataIntoSP(GesturePasswordDemoActivity.this, Constants.GPNAMEINSHARED,
                                     keyValueMap);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		Logger.e(
				...
				"defaultPass = "
						...
						+ resultPassword
						+ ", state = "
						+ SPUtil.getBooleanValueFromSP(this,
                                                       Constants.GSNAMEINSHARED, "state"));
		// 点返回键，先判断手势密码是否为空，若为空，保持开关状态为关；否则，开关状态不变
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			if ("".equals(defaultPassword)) {// 初始密码为空，手势密码未设置成功过，保持关闭状态
				SPUtil.setBooleanDataIntoSP(this,
                                            Constants.GSNAMEINSHARED, "state", false);
			}
			finish();
			return true;
