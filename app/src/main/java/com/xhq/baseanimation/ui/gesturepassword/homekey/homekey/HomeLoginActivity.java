package com.xhq.baseanimation.ui.gesturepassword.homekey.homekey;
...
import com.xhq.baseanimation.app.MainApplication;
import com.xhq.baseanimation.common.Constants;
import com.xhq.baseanimation.ui.gesturepassword.homekey.LocusPassWordView;
...
public class HomeLoginActivity extends Activity {
	...
	private OnClickListener forgetPasswordListener=new OnClickListener(){
		...
		public void onClick(View v) {
			...
			SPUtil.setDataIntoSP(HomeLoginActivity.this, Constants.GPNAMEINSHARED, keyValueMap);
			lpwv.clearPassword();
			SPUtil.setBooleanDataIntoSP(HomeLoginActivity.this, Constants.GSNAMEINSHARED, "state", false);
			MainApplication.getInstance().setLogin(false);
			if(fromHome) {//点击home键进入该页面，直接关闭该页面，进入到点home前的界面
				HomeLoginActivity.this.finish();
			}
