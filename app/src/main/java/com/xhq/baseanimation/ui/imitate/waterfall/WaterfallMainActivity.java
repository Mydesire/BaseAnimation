package com.xhq.baseanimation.ui.imitate.waterfall;
...
public class WaterfallMainActivity extends BaseActivity{
    ...
    public void setView(){
        ...
        ConstantValue.SCREEN_WIDTH = outSize.x;
        ConstantValue.SCREEN_HEIGHT = outSize.y;
        ...
        lv1.setOnItemLongClickListener(new OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id){
                ...
                if(ConstantValue.CONTENTVIEW_TOP_MARGIN == 0){
                    ...
                    ConstantValue.CONTENTVIEW_TOP_MARGIN = ConstantValue.SCREEN_HEIGHT - contentView.getHeight();
                }
    ...
    protected void showPop(ImageView tempIv){
        ...
        pop.showAtLocation(decorView, Gravity.CENTER, 0, ConstantValue.CONTENTVIEW_TOP_MARGIN / 2);
    ...
    protected PopupWindow getPopWindow(){
        if(pop == null){
            pop = new PopupWindow(tempIv, LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, true);
        }
        return pop;
    }
    ...
    protected ImageView getTempIV(){
        tempIv = (ImageView)View.inflate(this, R.layout.item_imitate_waterfall_lv, null);
        return tempIv;
    }
    ...
    private void initOptions(){
        options = new DisplayImageOptions.Builder()
                .showStubImage(R.drawable.pic_imitate_waterfall_default1) // resource or drawable
                .showImageForEmptyUri(R.drawable.pic_imitate_waterfall_default1) // resource or drawable
                .showImageOnFail(R.drawable.pic_imitate_waterfall_default1) // resource or drawable
    ...
    class MyAdapter1 extends BaseAdapter{
        ...
        public Object getItem(int position){
            return SERVER_IP + "/" + position % 50 + ".jpg";
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            if(convertView == null){
                convertView = View.inflate(getApplicationContext(),
                                           R.layout.item_imitate_waterfall_lv, null);
            ...
            String imageUri = SERVER_IP + "/"
                    + position % 50 + ".jpg";
            imageLoader.displayImage(imageUri, holder.iv, options, new ImageLoadingListener(){
    ...
    class MyAdapter2 extends BaseAdapter{
        ...
        @Override
        public Object getItem(int position){
            return SERVER_IP + "/a" + position % 20 + ".jpg";
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            String imageUri = SERVER_IP + "/a" + position % 20 + ".jpg";
            imageLoader.displayImage(imageUri, holder.iv, options, new ImageLoadingListener(){
                public void onLoadingStarted(String imageUri, View view){
                }
    ...
    class MyAdapter3 extends BaseAdapter{
        ...
        @Override
        public Object getItem(int position){
            return SERVER_IP + "/b" + position % 20 + ".jpg";
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ViewHolder holder;
            if(convertView == null){
                convertView = View.inflate(getApplicationContext(), R.layout.item_imitate_waterfall_lv, null);
                holder = new ViewHolder();
                holder.iv = convertView.findViewById(R.id.iv);
                convertView.setTag(holder);
            }else{
            ...
            String imageUri = SERVER_IP + "/b" + position % 20 + ".jpg";
            imageLoader.displayImage(imageUri, holder.iv, options, new ImageLoadingListener(){
                public void onLoadingStarted(String imageUri, View view){
                }
    ...
    public void setImageLoader(){
        ...
        int maxImgW = 480, maxImgH = 800;
        int quality = 75;
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(
                this)
                .memoryCacheExtraOptions(maxImgW, maxImgH)
                // default = device screen dimensions
                .discCacheExtraOptions(maxImgW, maxImgH, CompressFormat.JPEG, quality, null)
                .threadPoolSize(3)
                ...
                .discCacheSize(50 * 1024 * 1024).discCacheFileCount(100) // default
