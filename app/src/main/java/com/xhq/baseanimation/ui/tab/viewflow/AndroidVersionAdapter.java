package com.xhq.baseanimation.ui.tab.viewflow;
/*
 * 
...
import com.xhq.baseanimation.ui.tab.viewflow.library.TitleProvider;
...
public class AndroidVersionAdapter extends BaseAdapter implements TitleProvider {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null) {
			convertView = mInflater.inflate(R.layout.activity_tab_viewflow_flow_item, null);
		}
