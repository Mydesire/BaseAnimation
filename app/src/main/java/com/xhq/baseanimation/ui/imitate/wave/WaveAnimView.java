...
public class WaveAnimView extends FrameLayout {
    ...
    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.widget_imitate_wave_pay_anima, this);
        mImages[0] = (findViewById(R.id.radar_ray_1));
        mImages[1] = (findViewById(R.id.radar_ray_2));
        mImages[2] = (findViewById(R.id.radar_ray_3));
        mImages[3] = (findViewById(R.id.radar_ray_4));
    }
