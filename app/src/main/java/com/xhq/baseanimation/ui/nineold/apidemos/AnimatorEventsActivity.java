...
package com.xhq.baseanimation.ui.nineold.apidemos;
 ...
 */
public class AnimatorEventsActivity extends Activity {
    private static final int OFF = 0x553b3a40;
    private static final int ON  = 0xFF3b3a40;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nineold_animator_events);
