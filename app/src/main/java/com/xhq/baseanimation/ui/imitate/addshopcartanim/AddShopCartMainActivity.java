package com.xhq.baseanimation.ui.imitate.addshopcartanim;
...
public class AddShopCartMainActivity extends Activity {
	...
	private void initView() {
		shopCart = findViewById(R.id.shopping_img_cart);
		...
		ListView mListView = findViewById(R.id.product_list);
		ProductAdapter productAdapter = new ProductAdapter(getData());
