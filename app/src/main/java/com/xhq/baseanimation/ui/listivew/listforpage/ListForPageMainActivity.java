package com.xhq.baseanimation.ui.listivew.listforpage;
...
public class ListForPageMainActivity extends BaseActivity {
	...
	public void initView() {
		...
		preTextView = findViewById(R.id.txPreview);
		nextTextView = findViewById(R.id.txNext);
	...
	public void setListener() {
		...
		dao.insert();	//调用dao里面的insert()方法
		arrayList = dao.selectAll();	//调用dao里面的selectAll()方法
		//实例化适配器
		listAdapter = new ListAdapter(ListForPageMainActivity.this);
		//填充适配器
