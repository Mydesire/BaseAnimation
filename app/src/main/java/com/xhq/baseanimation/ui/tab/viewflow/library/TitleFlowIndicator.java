 ...
 */
package com.xhq.baseanimation.ui.tab.viewflow.library;
...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		// int textColor = a.getColor(R.styleable.Title, TEXT_COLOR);
		...
		initDraw(TEXT_COLOR, textSize, selectedColor, selectedBold,
