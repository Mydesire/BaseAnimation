 ...
 */
public abstract class AnimAdapter extends BaseAdapterDecorator {
	...
	public AnimAdapter(BaseAdapter baseAdapter) {
		super(baseAdapter);
		...
		if (baseAdapter instanceof AnimAdapter) {
			((AnimAdapter) baseAdapter).setHasParentAnimationAdapter(true);
		}
	}
	...
	public void reset() {
		...
		if (getDecoratedBaseAdapter() instanceof AnimAdapter) {
			((AnimAdapter) getDecoratedBaseAdapter()).reset();
		}
	}
	...
	private void animateView(int position, ViewGroup parent, View view, boolean isHeader) {
		...
		if (mDecoratedBaseAdapter instanceof AnimAdapter) {
			childAnimators = ((AnimAdapter) mDecoratedBaseAdapter).getAnimators(parent, view);
		} else {
